        ...
        <div className="container flex flex-wrap justify-between items-center mx-auto">
          ...
          <div className="w-full md:block md:w-auto centerContent" id="mobile-menu">
            <ul className="flex navbar flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
              ...
              <a href="#order-online" className="block text-2xl py-2 pr-3 pl-33 border-gray-100 hover:bg-gray-50 md:p-0 text-purple-800 ffLobsterTwo hover:text-purple-400">Order Online</a>
