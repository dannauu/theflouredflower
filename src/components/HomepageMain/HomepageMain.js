      ...
      <Fade bottom>
        <a href="#cakes" className="imageA flex flex-col items-center border-purple-800 bg-purple-100 rounded-lg shadow-md md:flex-row md:max-w-xl hover:bg-purple-900">
          ...
          <div className="flex flex-col justify-between p-4 leading-normal">
            ...
            <p className="textp mb-3 font-normal text-gray-700 centerText text-center">Bring your online cake inspirations to life for yourself or a special someone.</p>
          </div>
        </a>
        </Fade>
        <Fade top>
        ...
        <img className="image object-cover w-full h-full rounded-t-lg md:w-48 md:rounded-none md:rounded-l-lg" src={HomepageCardImg2} alt=""/>
          <div className="flex flex-col justify-between p-4 leading-normal">
            ...
            <p className="textp mb-3 font-normal text-gray-700 centerText text-center">My custom cookies range from homemade chocolate chip to a decorated holiday event or party.</p>
          </div>
      </a>
      </Fade>
      <Fade bottom>
