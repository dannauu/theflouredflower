...
const HomepageMain = () => {
  return (
    <div className='flex justify-evenly mt-20 mb-20 margin'>
        <a href="/menu" className="imageA flex flex-col items-center border-purple-800 bg-purple-100 rounded-lg shadow-md md:flex-row md:max-w-xl hover:bg-purple-900">
        ...
        <a href="/menu" className="imageA flex flex-col items-center bg-purple-100 rounded-lg border shadow-md md:flex-row md:max-w-xl hover:bg-purple-900">
      ...
      <a href="/menu" className="imageA flex flex-col items-center bg-purple-100 rounded-lg border-purple-400 shadow-md md:flex-row md:max-w-xl hover:bg-purple-900">
          <div className="flex flex-col justify-between p-4 leading-normal">
